...
const BaseActionsConfigurations = [action1Config, action2Config, action3Config, action4Config];
...
describe("test requestOnFullfilledInterceptor", () => {
  ...
  beforeEach(() => {
    ...
    requestOnFullfilledInterceptor = (0, _highOrderInterceptors.highOrderRequestOnFullfilledInterceptor)(dispatch, BASE_URL, BaseActionsConfigurations);
  });
...
describe("test requestOnRejectedInterceptor", () => {
  ...
  beforeEach(() => {
    ...
    dispatch = _jestMock.default.fn();
    requestOnRejectedInterceptor = (0, _highOrderInterceptors.highOrderRequestOnRejectedInterceptor)(dispatch, BASE_URL, BaseActionsConfigurations);
  });
  afterEach(() => {
...
describe("test responseOnFullfilledInterceptor", () => {
  ...
  beforeEach(() => {
    dispatch = _jestMock.default.fn();
    responseOnFullfilledInterceptor = (0, _highOrderInterceptors.highOrderResponseOnFullfilledInterceptor)(dispatch, BASE_URL, BaseActionsConfigurations);
  });
...
describe("test responseOnRejectedInterceptor", () => {
  ...
  beforeEach(() => {
    dispatch = _jestMock.default.fn();
    responseOnRejectedInterceptor = (0, _highOrderInterceptors.highOrderResponseOnRejectedInterceptor)(dispatch, BASE_URL, BaseActionsConfigurations);
  });
